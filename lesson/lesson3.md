...
## Домашнее задание
- Закончить реализацию `storage.AbstractArrayStorage`, `storage.ArrayStorage`, `storage.SortedArrayStorage` (`storage.SortedArrayStorage` хранит элементы отсортированными, сортировать весь массив не надо).
