...
- Реализуйте класс `storage.ArrayStorage` (вставте код в пустые методы класса): работа с `model.Resume` на основе массива (методы `clear, get, save, delete, getAll, size`)
